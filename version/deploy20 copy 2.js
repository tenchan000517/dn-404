...
async function main() {
    ...
    const config = {
        ...
        // テストネット用初期供給アドレス
        // initialSupplyAddress: "0xDC68E2aF8816B3154c95dab301f7838c7D83A0Ba",
    ...
    const contract = await TestToken.deploy();  // 引数なしでデプロイ
    
    await contract.deployed();
    console.log("Test token deployed to:", contract.address);

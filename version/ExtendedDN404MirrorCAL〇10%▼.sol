...
//         require(level <= 2, "Invalid level"); // ERC721-Cの制限に合わせる
//         CALLevel = level;
//     }
...
//     {
//         return
//             interfaceId == INTERFACE_ID_ERC721C || // ERC721-C
//             interfaceId == INTERFACE_ID_CONTRACT_LEVEL || // ContractLevel

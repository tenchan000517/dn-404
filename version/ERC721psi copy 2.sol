...
struct MintingConfig {
    ...
    uint64 publicSaleMaxMintAmountPerAddress; // 追加
    uint256 saleId; // saleIdは頻繁に参照されるため、uint256のまま維持
}
...
struct StateConfig {
    ...
    bool useSingleMetadata;
    bool useAnimationUrl; // 追加
}
    ...
    ReentrancyGuard
{
    ...
    StateConfig public stateConfig;
    ...
    constructor() ERC721Psi("TESTJAMDAO", "TEST") {
        ...
        mintConfig.maxSupply = 25000;
        mintConfig.maxMintAmountPerTransaction = 25000;
        mintConfig.publicSaleMaxMintAmountPerAddress = 25000;
        mintConfig.cost = 0;
        mintConfig.saleId = 0;

        stateConfig.paused = true;
        stateConfig.onlyAllowlisted = false;
        stateConfig.mintCount = true;
        stateConfig.burnAndMintMode = false;
        stateConfig.mintWithSBT = false;
        stateConfig.isSBT = false;
        stateConfig.useInterfaceMetadata = false;
        stateConfig.useSingleMetadata = false;
        stateConfig.useAnimationUrl = false;
        ...
        //_safeMint(0xDC68E2aF8816B3154c95dab301f7838c7D83A0Ba, 10000);
    ...
    uint256 public maxMintAmountPerTransaction = 25000;
    uint256 public publicSaleMaxMintAmountPerAddress = 25000;
    ...
    function setUseSingleMetadata(
        bool _useSingleMetadata
    ) public onlyRole(ADMIN) {

...
//         emit ConfigurationUpdated(string(abi.encodePacked("merkleRoot_phase_", LibString.toString(phase))), uint256(newRoot));
//     }
...
//         PhaseConfig storage config = phaseConfigs[phaseNumber];
//         return
//             PhaseStatus({
//                 isActive: config.isConfigured,
//                 isPaused: config.isPaused,
//                 totalMinted: phaseTotalMints[phaseNumber],
//                 price: config.price,

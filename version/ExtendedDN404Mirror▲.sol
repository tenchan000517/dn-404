...
//         if (isApprovedForAll(tokenOwner, operator)) return true;
//         for (uint256 i = 1; i <= calLevel; i++) {
//             if (calAllowedAddresses[i].contains(operator)) {
//                 return true;
//             }
//         }
//         return false;
...
//         require(_isAllowed(msg.sender, from), "Caller is not allowed to transfer");
